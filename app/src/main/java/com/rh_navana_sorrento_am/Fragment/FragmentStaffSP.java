 ...
 */
public class FragmentStaffSP extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        persons.add(new Person("Admin","Mehedi Hassan","Gardener","B-2","01458964557","Mehedi@nsrh.com",
                "To water the plant 2 times a day","Hasan","To water the plant 2 times a day"));

        persons.add(new Person("Admin","Md Sajid Nur","Night Guard","E-20","01658964557","Nur@nsrh.com",
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_sp_staff, container, false);
        if (v != null) {

            recyclerView = (RecyclerView) v.findViewById(R.id.rv_sp_staff);
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private FragmentStaffSP.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final FragmentStaffSP.ClickListener clickListener) {
